...
pub const COLOURS: Colours = Colours { // const colours storing ansi colour codes
    bold:   "\x1b[1m",
    reset:  "\x1b[0m",
    purple: "\x1b[35m",
    blue:   "\x1b[34m",
...
pub const HELP: &'static str = formatcp!("Try '{}{}tl{} --help{}' for more information", COLOURS.bold, COLOURS.purple, COLOURS.blue, COLOURS.reset);
pub const HELPMSG: &'static str = formatcp!("{}{}TL{}{} - A cli translator
{}{}---------------------{}{}
Author;  NewDawn0
License: MIT
